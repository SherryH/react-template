This repo contains the following basic setup to start a React project. CSS loader and Style loader are not included because I like using css-in-js for styling
